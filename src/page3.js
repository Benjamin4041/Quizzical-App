            ...
            <div style={{display:"flex",rowGap:"1em", flexDirection:"column"}}>
                <span style={{borderBottom:"1px solid black", padding:"1em"}}>
                    ...
                    <div style={{display:"flex", columnGap:"2em"}}>
                        <div style={{backgroundColor:"#94D7A2",padding:"0.2em 1em", borderRadius:"2em", cursor:"pointer"}}>Adiós</div>
                ...
                <span style={{borderBottom:"1px solid black", padding:"1em"}}>
                    ...
                    <div style={{display:"flex", columnGap:"2em"}}>
                        <div style={{backgroundColor:"#F8BCBC",padding:"0.2em 1em", borderRadius:"2em", cursor:"pointer"}}>Cabbage Patch Kids</div>
                        <div style={{border:"2px solid black",padding:"0.2em 1em", borderRadius:"2em", cursor:"pointer"}}>Transformers</div>
                        <div style={{backgroundColor:"#94D7A2",border:"2px solid #94D7A2",padding:"0.2em 1em", borderRadius:"2em", cursor:"pointer"}}>Care Bears</div>
                ...
                <span style={{borderBottom:"1px solid black", padding:"1em"}}>
                    ...
                    <div style={{display:"flex", columnGap:"2em"}}>
                        ...
                        <div style={{backgroundColor:"#94D7A2",padding:"0.2em 1em", borderRadius:"2em", cursor:"pointer"}}>Venus</div>
                ...
                <span style={{borderBottom:"1px solid black", padding:"1em"}}>
                    ...
                    <div style={{display:"flex", columnGap:"2em"}}>
                        <div style={{backgroundColor:"#F8BCBC",padding:"0.2em 1em", borderRadius:"2em", cursor:"pointer"}}>Italy</div>
                        <div style={{border:"2px solid black",padding:"0.2em 1em", borderRadius:"2em", cursor:"pointer"}}>Portugal</div>
                        <div style={{backgroundColor:"#94D7A2",border:"2px solid #94D7A2",padding:"0.2em 1em", borderRadius:"2em", cursor:"pointer"}}>Mexico</div>
                ...
                <span style={{borderBottom:"1px solid black", padding:"1em"}}>
                    ...
                    <div style={{display:"flex", columnGap:"2em"}}>
                        ...
                        <div style={{backgroundColor:"#94D7A2",padding:"0.2em 1em", borderRadius:"2em", cursor:"pointer"}}>Three</div>
                        <div style={{border:"2px solid black",padding:"0.2em 1em", borderRadius:"2em", cursor:"pointer"}}>Four</div>
                    </div>
                </span>
                <div style={{display:"flex",justifyContent:"center",alignItems:"center",columnGap:"0.5em"}}> 
                    <p>You scored 3/5 correct answers</p> 
                    <Btn style={{backgroundColor:"red"}}  btnName="Play again"/>
                </div>
            </div>
